...
const DATASETS = [
  ...
  },
  {
    ...
    uniqueKeys: [["slug"]],
    columns: {
      state: { type: "text", check: ["pending", "staked"] },
      customBetType: { type: "text", check: ["standard", "free_bet_offer"] },
      sport: { type: "text", check: ["horse_racing", "football", "golf"] },
      bookmaker: { type: "text", check: ["Ladbrokes"] },
      proposedBets: { type: "jsonb" },
      decimalOdds: { type: "numeric(10, 2)" },
      generatedAtIso: { type: "timestamptz" },
      eventStartIso: { type: "timestamptz" },
      eventEndIso: { type: "timestamptz" },
      suggestedStakeAmount: { type: "numeric(12, 2)" },
      isFreeStake: { type: "boolean" },
      placedProposalRank: { type: "integer" },
      stakeAmount: { type: "numeric(12, 2)" },
      placedDecimalOdds: { type: "numeric(10, 2)" },
      placedAtIso: { type: "timestamptz" },
      cashoutAdvice: { type: "jsonb" },
      watchPoints: { type: "jsonb" },
      riskFactors: { type: "jsonb" },
      horseRacing: { type: "jsonb" },
      football: { type: "jsonb" },
      golf: { type: "jsonb" },
    },
  },
